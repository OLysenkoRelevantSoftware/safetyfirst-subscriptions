      ...
      <Container maxWidth="lg">
        <Toolbar disableGutters sx={{ display: 'flex', justifyContent: 'space-between', py: 1 }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <Image src="/logo.svg" alt="SafetyFirst" width={140} height={106} style={{ display: 'block' }} />
            </Link>
          </Box>

          <Box component="div" sx={{ display: 'flex', alignItems: 'center', alignSelf: 'start' }}>
            <Typography variant="h5" sx={{ fontWeight: 700 }}>
              ...
              >
                <Image src="/phone.svg" alt="Phone" width={15} height={15} style={{ marginRight: 8 }} />              
                0371 346 0798
              </Link>
            </Typography>
          </Box>
